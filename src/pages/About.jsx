...
function About() {
  return (
    <div className="container mx-auto p-4">
      ...
      >
        <h1 className="text-4xl font-bold mb-4 text-blue-600 dark:text-blue-400">About Us</h1>
      ...
      <motion.div
        ...
        transition={{ duration: 0.5 }}
      >
        <h2 className="text-3xl font-bold text-center text-blue-600 dark:text-blue-400 mb-4">Our Mission</h2>
      ...
      <motion.div
        ...
        transition={{ duration: 0.5 }}
      >
        <h2 className="text-3xl font-bold text-blue-600 dark:text-blue-400 mb-4">Our Technology Stack</h2>
      ...
      <motion.div
        ...
        transition={{ duration: 0.5 }}
      >
        <h2 className="text-3xl font-bold text-center text-blue-600 dark:text-blue-400 mb-4">Meet Our Team</h2>
        <div className="flex justify-center gap-8">
          {/* Team Member 1 */}
          <div className="bg-white dark:bg-gray-700 p-6 rounded-lg shadow-md w-40">
            <img src="https://via.placeholder.com/150" alt="Team Member" className="w-full rounded-full mb-4" />
